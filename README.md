...
3. **Banco de Dados** – PostgreSQL, pgAdmin;
4. **Linguagens** – HTML, CSS, Python e Typescript;
5. **Framework/Bibliotecas** – Flask, Psycopg, React, MaterialUI, Tailwind, FramerMotion;
